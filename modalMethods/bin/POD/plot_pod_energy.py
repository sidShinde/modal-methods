...
def plot_pod_energy(configFile):
    '''
    Input
    -----
    ...
    caseDir = os.getcwd();
    fname = caseDir + '/postProcessing/POD/singVals_' + str( nSnaps ) + '.csv'
    ...
    fname = caseDir + '/postProcessing/POD/energy_snaps_' + str( nSnaps ) + '.pdf'
    plt.savefig(fname)
